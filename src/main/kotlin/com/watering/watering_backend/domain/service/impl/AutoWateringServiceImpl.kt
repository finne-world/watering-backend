...
class AutoWateringServiceImpl(
    ...
    override fun changeEnabled(deviceId: UUID, newEnabledValue: Boolean): ChangeEnabledResult = transaction {
        val oldEnabledValue: Boolean = autoWateringSettingRepository.getEnabledByDeviceId(deviceId).getOrElse { throw ResourceNotFoundException("auto_watering_setting resource not found. device_id=${deviceId}.") }
